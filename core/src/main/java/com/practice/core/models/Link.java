...
public interface Link<T> {
     ...
     * All new model implementation should use this name, some of the existing
     * models use other names to store the link URL.
     */
     ...
     *
     * @return Mapped link URL or {@code null} if link is invalid or no processing
     *         can be done
     */
    @Nullable
     ...
     * This is usually created with a {@link com.day.cq.commons.Externalizer}
     * service
     * 
     * @return Full link URL or {@code null} if link is invalid or can't be
     *         externalized.
     */
    @Nullable
     ...
     *
     * @return {@link Map} with HTML-specific anchor attributes, or an empty map if
     *         link is invalid
     * @since com.adobe.cq.wcm.core.components.commons.link 1.0.0
     */
    @NotNull
