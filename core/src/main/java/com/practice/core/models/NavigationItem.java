...
/**
 * Interface for a single navigation item, used by the {@link Breadcrumb} and
 * {@link Navigation} models.
 *
...
public interface NavigationItem extends ListItem {
     ...
     *
     * @return {@code true} if it is the current page or one of its ancestors,
    ...
    /**
     * Returns {@code true} if the page contained by this navigation item is the
     * current page.
     *
     ...
     *
     * @return the children of this {@code NavigationItem}; if this
     *         {@code NavigationItem} doesn't have any children, the returned
