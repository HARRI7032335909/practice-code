package com.practice.core.models.impl;
	...
	@Component(service = DemoService.class,immediate = true,name="vishnu")
	public class VishnuServieIMPL implements DemoService {
	    private static final Logger LOG= LoggerFactory.getLogger(VishnuServieIMPL.class);
