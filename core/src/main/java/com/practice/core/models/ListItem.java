...
/**
 * Interface for a generic list item, used by the {@link List} and
 * {@link Search} models.
 *
...
public interface ListItem extends Component {
    ...
    /**
     * Returns a wrapped resource of the item which is used to render the item as a
     * Teaser component.
     *
     ...
     * - null otherwise
     *
     * @return wrapped resource of the item which can be rendered as a Teaser
     *         component
     * @since com.adobe.cq.wcm.core.components.models 12.21.0
     */
    @Nullable
    default Resource getTeaserResource() {
        return null;
    }
