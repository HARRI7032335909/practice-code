 ...
 protected void activate(ComponentContext componentContext) {
		...
		try {
			...
			session.getWorkspace().getObservationManager().addEventListener(this,
				Event.PROPERTY_ADDED | Event.NODE_ADDED | Event.NODE_REMOVED | Event.NODE_MOVED |Event.PROPERTY_CHANGED |Event.PROPERTY_REMOVED, "/content/practice-code/us/en/jcr:content/root/container/container/surgetraining", true, null, null, false);			
